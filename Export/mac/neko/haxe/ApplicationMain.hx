class ApplicationMain
{
	...
	{
		#if nme
		nme.Lib.setPackage("NME", "AddingText", "io.nme.samples.addingtext", "1.0.0");
		...
		wx.App.boot(function()
		{
			...
			frame = wx.Frame.create(null, null, "Adding Text", null, { width: 800, height: 600 });
	...
	public static function getAsset(inName:String):Dynamic
	{
		...
		if (inName == "assets/KatamotzIkasi.ttf")
		{
			
			return nme.Assets.getFont ("assets/KatamotzIkasi.ttf");
